...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-[760px] h-svh overflow-hidden bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black cursor-none">
      ...
      {/* ================= 2. CINEMATIC PORTRAIT LAYER ================= */}
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-black">
        {/* A softly moving backdrop fills wide screens without enlarging or
            awkwardly cropping the foreground portrait. */}
        <motion.img
          src="/rajeev-sharma.jpeg"
          alt=""
          aria-hidden="true"
          className="absolute inset-0 h-full w-full object-cover object-[50%_38%] opacity-35 blur-[7px] scale-110"
          animate={{ scale: [1.1, 1.16, 1.1], x: [0, -16, 0] }}
          transition={{ duration: 16, repeat: Infinity, ease: 'easeInOut' }}
        />

        {/* Full portrait stays in proportion and moves gently like a video. */}
        <motion.img
          src="/rajeev-sharma.jpeg"
          alt="Rajeev Sharma"
          className="absolute inset-0 h-full w-full object-contain object-center opacity-85"
          animate={{ scale: [0.92, 0.96, 0.92], y: [8, -6, 8] }}
          transition={{ duration: 11, repeat: Infinity, ease: 'easeInOut' }}
        />

        {/* Dark editorial treatment keeps the portrait integrated with the
            original black-and-gold portfolio design. */}
